...
<head>
    ...
    <title>Lollyland - FamiFormation</title>
...
<body>
    ...
    <div class="tiles-container">
        <a href="lollyland.php" class="tile">
            <span class="tile-icon">🍬</span>
            <span class="tile-title">Remplir les bonbons (PDF)</span>
        </a>

        <a href="lollyland_methode_travail.php" class="tile">
            <span class="tile-icon">🛠️</span>
            <span class="tile-title">Méthode de travail</span>
        </a>
    </div>
